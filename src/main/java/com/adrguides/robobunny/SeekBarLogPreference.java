...
public class SeekBarLogPreference extends Preference implements OnSeekBarChangeListener {
    ...
    public SeekBarLogPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPreference(context, attrs);
    }

    public SeekBarLogPreference(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        ...
        format = new DecimalFormat(getAttributeStringValue(attrs, APPLICATIONNS, "format", "#,##0%"));
        exponent = attrs.getAttributeFloatValue(APPLICATIONNS, "exponent", 2.0f);
        factor = attrs.getAttributeFloatValue(APPLICATIONNS, "factor", 0.1f);
    }
    ...
    protected void updateView(View view) {
        ...
        try {
            ...
            mStatusText.setText(calculateDisplayedValue(mCurrentValue));
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        mStatusText.setText(calculateDisplayedValue(newValue));
        persistInt(newValue);

    }

    private String calculateDisplayedValue(int value) {
        return format.format(Math.pow(exponent, value * factor));
    }
